...
*/
int Plane::intersection(const Ray3D& ray, std::vector<Point3D>& intPoints) const
{
	Point3D intPoint;
	bool intersected = Arithmetic::ray_intersect_plane(point, normal_vector, ray, intPoint);
	if (intersected) {
