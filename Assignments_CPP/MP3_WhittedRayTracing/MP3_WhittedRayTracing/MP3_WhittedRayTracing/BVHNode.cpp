...
*/
BVHNode::BVHNode() : Object(ObjectType::BVHNode, Material()) {}
...
*/
BVHNode::BVHNode(const std::shared_ptr<TriangleMesh>& triangleMesh) : Object(ObjectType::BVHNode, Material())
{
...
*/
BVHNode::BVHNode(const std::vector<std::shared_ptr<Object>>& src_objects, size_t start, size_t end) : Object(ObjectType::BVHNode, Material())
{
    leaf = false;
